...
//						e.stopPropagation();
						...
						if (evt.button == 2) {
						    ...
						    //							$(menu).css({ top: y, left: x }).fadeIn(o.inSpeed);
						    							$(".context-menu").fadeIn(o.inSpeed).offset({ top: y, left: x }); // must be visible, before calling offset()
						    							// Hover events
				...
				$(el).add($('DIV.contextMenu')).bind('contextmenu', function() { return false; }); // cambie UL por DIV
