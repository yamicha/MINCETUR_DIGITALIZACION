...
function Documento_ConfigurarGrilla_Vent_Pen() {
    ...
    var colNames = [
        'N° Exp.', 'Recibir', 'Fec. Reg. Exp.', 'Solicitante', 'Asunto', 'Clasificación', 'Tipo Doc.', 'Observaciones', 'Num Doc', 'Folios', 'Usuario'
    ]
    var colModels = [
        ...
        { name: 'DES_CLASIF', index: 'DES_CLASIF', align: 'left', hidden: false, width: 200},//6
        { name: 'DES_TIP_DOC', index: 'DES_TIP_DOC', align: 'left', hidden: false, width: 200 },//7
        { name: 'DES_OBS', index: 'DES_OBS', align: 'left', hidden: false, width: 150 },
        { name: 'NUM_DOC', index: 'NUM_DOC', align: 'left', hidden: true, width: 150 },
...
function GetRules() {
    ...
    _gs_NROEXPEDIENTE = $('#gs_' + 'ID_EXPE').val();
    _gs_DES_OBS = $('#gs_' + 'DES_OBS').val();
    //
