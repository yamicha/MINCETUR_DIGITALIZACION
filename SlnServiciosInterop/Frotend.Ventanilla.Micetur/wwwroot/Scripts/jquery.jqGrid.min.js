...
g+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+J+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+g+"'></span></span>");for(e=0;e<this.p.colNames.length;e++)J=a.p.headertitles?' title="'+b.jgrid.stripHtml(a.p.colNames[e])+'"':"",C+="<th id='"+a.p.id+"_"+a.p.colModel[e].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+g+"'"+J+">",J=a.p.colModel[e].index||a.p.colModel[e].name,C+="<div id='jqgh_"+a.p.id+"_"+a.p.colModel[e].name+"' "+ma+">"+(e==0?"<i class=\"clip-tag-2\"></i>":a.p.colNames[e]),
