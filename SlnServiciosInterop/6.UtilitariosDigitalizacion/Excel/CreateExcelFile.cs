...
namespace Utilitarios.Excel
{
    public class CreateExcelFile
    {
        public static bool CreateExcelDocument<T>(List<T> list, string xlsxFilePath, Titulo titulo, bool solo_columna, string NombreHoja, List<Columnas> columnas = null)
        {
        ...
        public static DataTable ListToDataTable<T>(List<T> list, bool solo_columna, List<Columnas> columnas = null)
        {
            DataTable dt = new DataTable();
            if (!solo_columna)
            {
                foreach (Columnas columna in columnas)
                {
                    bool valido = false;
        ...
        public static bool CreateExcelDocument(DataSet ds, string excelFilename, Titulo titulo, bool solo_columna, List<Columnas> columnas, string NombreHoja)
        {
            try
            {
        ...
        private static void WriteExcelFile(DataSet ds, SpreadsheetDocument spreadsheet, Titulo titulo, bool solo_columna, List<Columnas> columnas, string NombreHoja)
        {
            {
                ...
                if (titulo != null)
                {
                    ...
                    string CODIGO = GenerarCodigo.GenerarCodigoTemporal();
                    string CODIGO_NOMBRE = CODIGO + ".png";
                    ruta_temporal =  Rutas.Ruta_Temporal()+ CODIGO_NOMBRE;
                    resized.Save(ruta_temporal, System.Drawing.Imaging.ImageFormat.Png);

                    ExcelTools.AddImage(wsPart, ruta_temporal, "My first image", 1, 1); // A1
                }
                if (titulo != null)
                {
