...
namespace DaServiciosDigitalizacion.Ventanilla.Administracion
{
    public class DaOperador : daBase
    {
        ...
        public List<enOperador> Operador_Listar(enOperador entidad, ref enAuditoria auditoria)
        {
            ...
            cmd.CommandText = AppSettingsHelper.PackAdmConsVentanilla + ".PRC_CDVOPERADOR_LISTAR";
        ...
        public void Operador_Insertar(enOperador entidad, ref enAuditoria auditoria)
        {
            ...
            using (OracleConnection cn = new OracleConnection(base.CadenaConexion))
            {
                ...
                var commantext = string.Format("{0}.{1}", AppSettingsHelper.PackAdmManVentanilla, "PRC_CDVOPERADOR_INSERTAR");
        ...
        public void Operador_Estado(enOperador entidad, ref enAuditoria auditoria)
        {
            ...
            using (OracleConnection cn = new OracleConnection(base.CadenaConexion))
            {
                cn.Open();
                OracleDataReader dr = null;
                OracleCommand cmd = new OracleCommand(string.Format("{0}.{1}", AppSettingsHelper.PackAdmManVentanilla, "PRC_CDVOPERADOR_ESTADO"), cn);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
