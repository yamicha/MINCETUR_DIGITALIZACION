...
namespace DaServiciosDigitalizacion.ArchivoCentral.Administracion
{
    public class DaSoporte : daBase
    {
        ...
        public List<enSoporte> Soporte_Listar(enSoporte objenSubSerie, ref enAuditoria auditoria)
        {
            ...
            cmd.Parameters.Add("XIN_DESC_SOPORTE", validarNulo(objenSubSerie.DESC_SOPORTE));
        ...
        public enSoporte Soporte_ListarUno(enSoporte objenSubSerie, ref enAuditoria auditoria)
        {
            ...
            cmd.Parameters.Add("XIN_ID_SOPORTE", validarNulo(objenSubSerie.ID_SOPORTE));
        ...
        public void Soporte_Insertar(enSoporte entidad, ref enAuditoria auditoria)
        {
            ...
            using (OracleConnection cn = new OracleConnection(base.CadenaConexion))
            {
                ...
                OracleCommand cmd = new OracleCommand(string.Format("{0}.{1}", AppSettingsHelper.PackAdminMant, "PROC_CDASOPORTE_INSERTAR"), cn);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add(new OracleParameter("XIN_DESC_SOPORTE", OracleDbType.Varchar2)).Value = entidad.DESC_SOPORTE;
        ...
        public void Soporte_Actualizar(enSoporte entidad, ref enAuditoria auditoria)
        {
            ...
            using (cn = new OracleConnection(base.CadenaConexion))
            {
                cn.Open();
                OracleDataReader dr = null;
                OracleCommand cmd = new OracleCommand(string.Format("{0}.{1}", AppSettingsHelper.PackAdminMant, "PROC_CDASOPORTE_ACTUALIZAR"), cn);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add(new OracleParameter("XIN_ID_SOPORTE", OracleDbType.Long)).Value = entidad.ID_SOPORTE;
                cmd.Parameters.Add(new OracleParameter("XIN_DESC_SOPORTE", OracleDbType.Varchar2)).Value = entidad.DESC_SOPORTE;
        ...
        public void Soporte_Estado(enSoporte entidad, ref enAuditoria auditoria)
        {
            ...
            using (OracleConnection cn = new OracleConnection(base.CadenaConexion))
            {
                cn.Open();
                OracleDataReader dr = null;
                OracleCommand cmd = new OracleCommand(string.Format("{0}.{1}", AppSettingsHelper.PackAdminMant, "PROC_CDASOPORTE_ESTADO"), cn);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add(new OracleParameter("XIN_ID_SOPORTE", OracleDbType.Long)).Value = entidad.ID_SOPORTE;
        ...
        public void Soporte_Eliminar(enSoporte entidad, ref enAuditoria auditoria)
        {
            ...
            using (OracleConnection cn = new OracleConnection(base.CadenaConexion))
            {
                cn.Open();
                OracleDataReader dr = null;
                OracleCommand cmd = new OracleCommand(string.Format("{0}.{1}", AppSettingsHelper.PackAdminMant, "PROC_CDASOPORTE_ELIMINAR"), cn);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add(new OracleParameter("XIN_ID_SOPORTE", OracleDbType.Long)).Value = entidad.ID_SOPORTE;
                cmd.Parameters.Add(new OracleParameter("XOUT_VALIDO", OracleDbType.Int32)).Direction = System.Data.ParameterDirection.Output;
                cmd.Parameters.Add(new OracleParameter("XOUT_MENSAJE", OracleDbType.Varchar2, 200)).Direction = System.Data.ParameterDirection.Output;
